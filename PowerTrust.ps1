...
function Invoke-ReverseBastion {
    ...
    $block = {
        ...
        $trust = [System.DirectoryServices.ActiveDirectory.Domain]::GetDomain([System.DirectoryServices.ActiveDirectory.Forest]::GetForest($using:TargetDomain)).GetAllTrustRelationships() | Where-Object {
