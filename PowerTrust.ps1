...
function Invoke-PSADSession {
    ...
    Invoke-Command -Session $s -ScriptBlock {
        # Note that `[System.Reflection.Assembly]::LoadFile()` has already been used locally before the remote session was created, and we're using the `$Using:` modifier to pass it to the remote session.
